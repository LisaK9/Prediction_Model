...
def load_and_preprocess_data(filepath):
    """
        ...
        filtered_data = data[data.index <= max_date_limit] # Filtere die Daten bis zum 14. des Max-Datums
...
def define_feature_selectors():
    """
       ...
       """
    feature_selectors = {
        'RFE': RFE(estimator=SVR(kernel='linear'), n_features_to_select=None),  # Keine feste Anzahl von Features
        'Univariate': SelectKBest(score_func=f_regression, k='all'),  # Alle Features testen
